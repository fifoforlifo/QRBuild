...
namespace QRBuild
{
    ...
    public sealed class BuildGraph
    {
        ...
        public ICollection<string> GetNonGeneratedFilePaths(BuildOptions buildOptions)
        {
            ComputeDependencies(buildOptions);
            if (!m_initialDependenciesValid) {
                return null;
            }
        ...
        public ICollection<string> GetGeneratedFilePaths(BuildOptions buildOptions)
        {
            ComputeDependencies(buildOptions);
            if (!m_initialDependenciesValid) {
                return null;
        ...
        private bool TimedComputeDependencies(BuildResults buildResults, BuildOptions buildOptions)
        {
            buildResults.ComputeDependenciesStartTime = DateTime.Now;
            ComputeDependencies(buildOptions);
            buildResults.DependenciesValid = m_initialDependenciesValid;
            buildResults.ComputeDependenciesEndTime = DateTime.Now;
            return m_initialDependenciesValid;
        }
        ...
        {
            m_initialDependenciesValid = false;
            bool result = true;
            ...
            m_initialDependenciesValid = result;
        }
        ...
        {
            bool computeDependenciesSuccess = TimedComputeDependencies(buildResults, buildOptions);
            if (!computeDependenciesSuccess) {
                return false;
            }

            //  Reset all BuildNodes' status.
            foreach (BuildTranslation translation in m_translations) {
            ...
            BuildProcess buildProcess = new BuildProcess(this, action, buildOptions, buildResults);
            bool result = buildProcess.Run(buildNodes, processDependencies);
            return result;
        }
        ...
        private bool m_initialDependenciesValid;
