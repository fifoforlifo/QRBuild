...
namespace QRBuild.Engine
{
    ...
    public sealed class BuildGraph
    {
        ...
        /// Returns all targets that are not generated by this BuildGraph.
        public ICollection<string> GetNonGeneratedFilePaths()
        {
            ...
            foreach (var kvp in m_buildFiles) 
            {
                ...
                {
                    inputs.Add(buildFile.Id);
                }
            }
            return inputs;
        }

        /// Returns all Targets that are generated by this BuildGraph.
        ...
        {
            foreach (string input in translation.GetInputs()) 
            {
        ...
        {
            bool result = true;
            foreach (string output in translation.GetOutputs()) 
            {
                ...
                if (IsTargetGenerated(buildFile)) 
                {
                    Trace.TraceError("Target {0} claims to be generated by more than one Translation:\n    {1}\n    {2}\n",
                        buildFile.Id,
                        buildFile.BuildNode.Translation.Name,
                        translation.Name);
                    result = false;
                }
                else 
        ...
        private void ComputeDependencies()
        {
            ...
            foreach (BuildTranslation translation in m_translations)
            {
                ...
                {
                    Trace.TraceError("Translation {0} has null DepsCachePath.", translation.Name);
                    return;
                }
